import type { IUser, IVideoConferenceUser, VideoConference } from '@rocket.chat/core-typings';
 ...
 */
export const conferenceNameFor = (call: NameableConference, viewerId: IUser['_id'] | undefined, subscriptionName?: string): string => {
	// Only a group conference has a name of its own, and it wins whenever someone has set one.
	...
	return call.type === 'direct' ? displayName(otherParty(call, viewerId)) : '';
};
