...
/**
 * The same green a raised hand wears on a tile, in a pill.
 *
 * Deliberately the identical colour rather than a near-miss: a raised hand is one state, and the label up here and
 * the badge on the tile are the same fact said in two places. It was a translucent grey before, which read as
 * disabled chrome next to the button beside it — the thing it is announcing looked like the least important thing
 * in the bar.
 *
 * Its own colours rather than theme tokens because the call's surface is dark in either theme.
 */
const HAND_GREEN = 'rgb(54 135 58 / 95%)';
...
const buttonStyles = css`
	...
	&:hover,
	&:focus-visible {
		background-color: rgb(64 155 68 / 95%);
	}
`;
